...
const char* NodeShape::strings[] = {"",
                                    ...
                                    "box3d",
                                    "component"};
const char* EdgeStyle::strings[] = {"",      "dashed", "dotted", "solid",
                                    "invis", "bold",   "tapered"};
const char* NodeStyle::strings[] = {"",        "dashed", "dotted", "solid",
                                    "invis",   "bold",   "filled", "diagonals",
                                    "rounded", "radial"};
const char* EdgeArrowTypeName::strings[] = {
...
const char* OutputMode::strings[] = {"", "breadthfirst", "nodesfirst",
                                     "edgesfirst"};
const char* PageDir::strings[] = {"",   "BL", "BR", "TL", "TR",
                                  "RB", "RT", "LB", "LT"};
...
const char* SmoothType::strings[] = {"",           "none",       "avg_dist",
                                     "graph_dist", "power_dist", "rng",
                                     "spring",     "triangle"};
const char* SplineType::strings[] = {"",      "line",     "spline", "polyline",
                                     "ortho", "compound", "count"};
const char* ImageScaleType::strings[] = {"", "width", "height", "both"};
const char* DirType::strings[] = {"", "forward", "back", "both", "none"};
const char* CompassPoint::strings[] = {"",  "n",  "ne", "e",  "se",
                                       "s", "sw", "w",  "nw", "c"};
const char* AttributeType::strings[] = {"Damping",
                                        "K",
                                        "URL",
                                        "area",
                                        "arrowhead",
...
const char* EdgeArrowTypeName::ToString(EdgeArrowTypeName::e val) {
  if (val < COUNT) return strings[val];
